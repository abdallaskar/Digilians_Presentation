...
const aiProjects = {
    "Data Engineering Specialist": [
        ...
        },
        {
            ...
            objective: "To analyze <b>smart city data</b> to detect traffic congestion, pollution, and improve urban services. This requires designing a scalable, high-throughput real-time streaming architecture using tools like Kafka and Spark. The goal is to provide a live dashboard showing traffic flow and air quality metrics for urban planners.",
        ...
        },
        {
            ...
            objective: "To enhance <b>healthcare quality</b> through patient data analytics and disease pattern detection. This involves designing a robust ETL pipeline to clean, transform, and harmonize disparate patient records from various sources. The final system should support interactive reporting on the most common diseases by region.",
        ...
        },
        {
            ...
            objective: "To <b>optimize traffic management</b> using <b>real-time data analytics</b> and visualization. This requires setting up a fast stream processing system using technologies like Kafka, Spark, and Elasticsearch. The goal is to deliver a real-time dashboard showing live road traffic and accurate congestion rates for rapid response.",
    ...
    "Professional Big Data Engineer": [
        {
            ...
            objective: "To design a <b>scalable real-time analysis system</b> to identify traffic congestion, reroute vehicles, and reduce urban traffic burden dynamically. This involves building high-throughput streaming pipelines capable of processing diverse, unstructured data sources instantaneously. The project utilizes an agentic AI component to simulate and recommend rerouting actions for traffic optimization.",
        ...
        },
        {
            ...
            objective: "To analyze customer <b>behavior patterns</b> to predict churn and develop autonomous strategies for user retention. This project focuses on building sophisticated machine learning models to identify at-risk customers with high accuracy and low false positives. The agentic AI component is then employed to execute dynamic, personalized retention suggestions automatically. ",
    ...
    "Machine Learning Developer": [
        {
            ...
            objective: "To develop an <b>AI assistant</b> combining transformer architectures with Retrieval-Augmented Generation (RAG) for highly accurate and context-aware medical responses. This integration is essential for achieving trustworthy and ethical healthcare communication through the chatbot. The project emphasizes integrating multilingual understanding and robust ethical AI safeguards.",
        ...
        },
        {
            ...
            objective: "To create an <b>intelligent recruitment tool</b> using LLMs and semantic similarity models for candidate evaluation. This system leverages advanced NLP and knowledge graphs to deliver explainable and equitable AI in recruitment automation. The primary goal is to ensure unbiased candidate ranking while accurately detecting skill relevance.",
        ...
        },
        {
            ...
            objective: "To develop a <b>robust vision-based gesture recognition model</b> using transfer learning and advanced pose estimation techniques. This project focuses on training and deploying a CNN-based classifier integrated with Mediapipe and Edge ML tools. The goal is to interpret dynamic hand movements accurately to control applications or devices in real time.",
        ...
        },
        {
            ...
            objective: "To show practical application of <b>LLMs for time-series decision support systems</b>. This involves scraping real-time financial news, processing it using transformer models, and classifying its sentiment. The final goal is a news dashboard that shows sentiment score, price impact, and plots over time for user analysis.",
        ...
        },
        {
            ...
            objective: "To implement <b>facial feature extraction</b> and <b>real-time image matching for identity</b>. This involves training a deep learning model (like FaceNet or a CNN) to accurately recognize student faces in different lighting conditions. The goal is a system that records attendance by scanning faces with time stamps for automated tracking.",
        ...
        },
        {
            ...
            objective: "To explore <b>reinforcement learning (RL)</b> for real-world optimization tasks like delivery and obstacle avoidance. This involves building a simulation environment (e.g., with OpenAI Gym) where the drone learns through trial and error to minimize distance and flight time. The final result is a simulated drone path planner that learns to avoid obstacles and minimize delivery time.",
