...
const infraSecurityProjects = {
    ...
    "Cisco Network Administration Professional": [
...

        {
            ...
            objective: "To configure a secure, <b>multi-tenant, virtualized Data Center</b> network using VRF and sub-interfaces to isolate traffic between tenants. This involves designing the core network infrastructure, configuring the routing and switching devices, and implementing the VRF technology. The final goal is to ensure a secure, fully isolated environment for multiple customers on the same physical network.",
        ...
        },
        {
            ...
            objective: "To configure a redundant, dual-homed <b>Enterprise Edge</b> network using BGP for high availability and failover. This involves establishing BGP sessions with two separate Internet Service Providers (ISPs) to ensure external connectivity. The configuration must include advanced routing policies and path manipulation for optimal traffic routing.",
        ...
        },
        {
            ...
            objective: "To implement a <b>Disaster Recovery (DR) infrastructure</b> that protects enterprise data and ensures service continuity in the event of a primary site outage. This involves configuring a secure, reliable connection between the DC and DR site using IPsec VPN tunnels. The project focuses on implementing robust routing protocols (OSPF/EIGRP/BGP) and backup DNS/DHCP services to support failover scenarios.",
        ...
        },
        {
            ...
            objective: "To implement a <b>multi-layered security approach</b> (802.1X/NAC and MAB) to control access to the healthcare network rigorously. This involves creating granular VLAN segments to isolate sensitive 'Patient Records' and 'Medical Devices' traffic from staff access. The objective is to ensure HIPAA compliance and robust security by controlling all device access (wired and wireless).",
        ...
        },
        {
            ...
            objective: "To integrate a <b>Linux web service</b> with <b>Windows Active Directory</b> to automate the task of new user onboarding. This involves using PowerShell/Python scripts to create a user, set the initial password, and apply necessary group memberships and organizational units (OUs). The final outcome is a deployable solution that drastically reduces manual overhead for IT administrators.",
    ...
    "Network Administration Specialist": [
        ...
        },
        {
            ...
            objective: "To create a <b>seamless, hybrid-OS environment</b> that enables centralized management, strong segmentation, and identity enforcement. This involves integrating AD user credentials for SSH login on Linux servers via a secure VPN/tunnel, maintaining strict security standards. The final project focuses on applying granular access controls (ACLs) to applications and network segments.",
        ...
        },
        {
            ...
            objective: "To deploy a <b>segmented network design</b> that integrates corporate (IT) and operational technology (OT) environments, ensuring safety and compliance. This involves deploying a strong firewall to isolate the two segments and applying strict access control rules (ACLs) to prevent lateral movement. The primary goal is to protect sensitive corporate data and factory controllers from external compromise.",
        ...
        },
        {
            ...
            objective: "To build a <b>scalable, multi-tenant network core</b> capable of servicing customer VLANs and managing internet services efficiently. This involves configuring OSPF as the IGP for interior routing and deploying NAT/PAT for customer service. The project demonstrates dynamic routing protocols and address translation for managing internet services.",
        ...
        },
        {
            ...
            idea: "Build an idempotent network where the core layer is heterogeneous, consisting of Cisco and Huawei devices. Configure the core layer to support VLAN trunking and inter-VLAN routing.",
            objective: "To implement a <b>dual-vendor network core</b> capable of seamless interoperability between Cisco and Huawei devices. This involves configuring both Cisco and Huawei devices to support VLAN trunking and inter-VLAN routing. The project demonstrates proficiency in managing a heterogeneous network environment.",
        ...
        },
        {
            ...
            objective: "To design a resilient <b>unified network infrastructure</b> that supports high-availability wired and wireless access for both IT and Operational Technology (OT) functions. This involves deploying a secure wireless solution optimized for high-density IoT/OT devices, ensuring seamless connectivity for automated sorting machines. The project emphasizes integrating backup WAN connectivity to ensure continuous operations and inventory data flow.",
    ...
    "Cisco Cybersecurity Professional": [
        {
            ...
            objective: "To design a <b>segmented VLAN network</b> for effective traffic isolation and security monitoring. This involves deploying Snort IDS for intrusion monitoring and conducting ethical hacking tests using Nmap. The final objective is to report on the detection accuracy and traffic isolation within the multi-VLAN topology.",
        ...
        },
        {
            ...
            objective: "To simulate a <b>Red-team vs Blue-team exercise</b> using the MITRE ATT&CK framework for incident response and defense. This involves configuring complex inter-VLAN routing and running a continuous ethical penetration test. The project emphasizes analyzing the full simulation results and mapping them to MITRE ATT&CK tactics for SOC evaluation.",
        ...
        },
        {
            ...
            objective: "To harden <b>SMB perimeter defense</b> against external threats by implementing Access Control Lists (ACLs) and Network Address Translation (NAT). This involves integrating Snort rules for effective threat hunting and exploiting weak SMB services using tools like Burp Suite. The final goal is to document intrusions, blocked exploits, and propose recommended security improvements for robust network defense.",
        ...
        },
        {
            ...
            objective: "To integrate <b>wireless and wired network security</b> controls and actively hunt for Wi-Fi exploits and lateral movement attacks. This involves setting up separate wireless VLANs and monitoring the network using Kibana dashboards for real-time visibility. The final objective is to document effective lateral movement blocks and analyze the success rate of deauthentication and other Wi-Fi exploits.",
        ...
        },
        {
            ...
            objective: "To conduct a <b>full kill-chain attack</b> simulation across an enterprise network and perform defensive monitoring and incident response. This involves building a multi-layered core/distribution/access network and aggregating all logs into an ELK stack for centralized analysis. The final output is a detailed timeline of attack stages, identified indicators of compromise (IOCs), and corresponding response efficiency.",
    ...
    "Vulnerability Analysis & Penetration Testing Professional": [
        {
            ...
            objective: "To automate <b>vulnerability discovery and exploitation</b> tasks, including mapping, exploitation, and reporting. This involves researching and customizing tools for different types of networks, web applications, and systems. The goal is to perform ethical hacking simulations and provide comprehensive reporting of vulnerabilities with suggested mitigations.",
        ...
        },
        {
            ...
            objective: "To teach <b>post-exploitation detection, forensics, and incident response clean up procedures</b> in a web server environment. This involves performing deep digital forensics analysis to discover the web shell, analyze the attack's persistence mechanisms, and extract compromised data. The ultimate goal is to remove backdoors and harden systems against future attacks effectively.",
        ...
        },
        {
            ...
            objective: "To demonstrate <b>web application defense</b> skills with an emphasis on developing secure code against common application-layer attacks. This involves conducting black-box testing to identify and bypass Web Application Firewall (WAF) rules and methods. The project requires auditing the application's backend code to identify insecure coding practices and provide remediation solutions.",
        ...
        },
        {
            ...
            objective: "To implement the highest level of <b>API security</b> by detecting and mitigating complex microservices chain attacks. This involves testing authentication and authorization flows across multiple APIs to discover vulnerabilities like insecure deserialization and SSRF. The core goal is to chain multiple API flaws together to access protected data, emphasizing enhanced API authentication.",
        ...
        },
        {
            ...
            objective: "To improve the <b>security of IoT and embedded devices</b> by identifying firmware and network vulnerabilities and providing mitigation strategies. This involves performing firmware extraction and analysis, local network testing, and checking for API/firmware update vulnerabilities. The final goal is to enhance the overall network security and device integrity of the embedded system.",
        ...
        },
        {
            ...
            objective: "To develop a practical understanding of <b>SQL Injection (SQLi) vulnerabilities</b> in web applications, demonstrating how attackers can use SQLi to interfere with database queries. This involves setting up a vulnerable web application, creating exploitation scripts, and understanding how to properly validate and sanitize input. The final project provides data extraction, manipulation, and mitigation techniques against SQLi.",
