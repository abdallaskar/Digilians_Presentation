...
const dataAnalyticsProjects = {
    ...
    "Junior Data Analyst": [{
        ...
        objective: "To master **data loading and preprocessing** focusing on cleaning and preparing the data, identifying patterns, and extracting features from sensor and weather datasets. This project involves training a machine learning model (e.g., Regression or Classification) to accurately predict AQI values using actual sensor readings. The final analysis compares actual readings to predicted AQI trends and highlights key factors contributing to air quality changes.",
    ...
    },
    {
        ...
        objective: "To explore and preprocess the **housing dataset**, focusing on handling missing values and engineering relevant property features (e.g., bedrooms, size, neighborhood). This project involves training and evaluating various regression models (e.g., Linear Regression, Random Forest, XGBoost) to accurately predict house prices. The final analysis evaluates model performance using metrics like RMSE and R-square, identifying which features most influence house prices.",
    ...
    },
    {
        ...
        objective: "To count the **number of trips** and calculate average trip durations per customer over time and distance traveled. This involves generating charts showing trip patterns, popular destinations, and daily/weekly usage trends. The final goal is to build a dashboard with notifications for maintenance based on mileage thresholds.",
    ...
    },
    {
        ...
        objective: "To load and clean the **vehicle registration dataset**, performing exploratory data analysis to identify usage patterns by region, vehicle type, and time. This project requires training a predictive model for future EV adoption rates, focusing on strategic insights for infrastructure planning and policy making. The final report forecasts EV adoption registrations with recommendations for infrastructure deployment.",
        tools: ["Python", "Pandas", "NumPy", "scikit-learn", "Matplotlib/Seaborn", "Jupyter Notebook"],
    },
    {
    ...
    },
    {
        ...
        objective: "To gather and clean historical **gold and silver price data** from online financial sources, conducting exploratory data analysis to uncover trends and patterns. This project involves training time-series models (e.g., Random Forest, XGBoost) to accurately predict daily gold and silver prices. The final goal is to provide visualizations of actual vs. predicted prices, feature importance insights, and a report guiding investment or risk-management decisions.",
    ...
    },
    {
        ...
        objective: "To connect a MySQL database using **Python**, implementing functions to add, remove, promote, and display employee records. This involves ensuring data persistence and integrity throughout the system's life cycle, managing sensitive data securely. The final goal is a working application where users can manage employee records via a simple, menu-driven interface.",
    ...
    "Professional Data Analyst": [
        {
            ...
            objective: "To master **Exploratory Data Analysis (EDA)**, focusing on cleaning missing or incorrect values and extracting key features from survey data. This project involves training a classification model to accurately predict vaccine uptake based on various demographic and health factors. The final analysis identifies which factors drive vaccine uptake and reports on results.",
        ...
        },
        {
            ...
            objective: "To analyze customer data to identify **key features influencing loan approval** and to handle imbalanced classes and complex missing data. This involves training and evaluating various classification models (e.g., Logistic Regression or Decision Trees) to predict the outcome. The final deliverable provides insights on factors contributing to approval or rejection.",
            tools: ["Python", "Pandas", "NumPy", "scikit-learn", "Matplotlib", "Jupyter Notebook"],
        },
        {
            ...
            objective: "To explore **patterns in manufacturing defects** through rigorous EDA and feature identification. This project focuses on preparing the data for predictive modeling to classify and identify patterns and features associated with defect production. The final goal is to build a dashboard using classification models (e.g., Random Forest or Support Vector Machine) to predict which batches have high defect risk.",
            tools: ["Python", "Pandas", "NumPy", "scikit-learn", "Matplotlib", "Seaborn", "Jupyter Notebook"],
        },
        {
            ...
            objective: "To master **Web Scraping** using the Python libraries Requests and Beautiful Soup to collect product data from online e-commerce platforms. This involves transforming and cleaning the extracted unstructured data into a usable tabular format suitable for business intelligence analysis. The final output is a structured dataset ready for visualization or predictive modeling applications.",
        ...
        },
        {
            ...
            objective: "To explore and analyze **time-series traffic data** from multiple junctions, focusing on feature engineering for temporal components (hourly, daily, weekly) in vehicle counts. This project requires training and evaluating various time-series models (e.g., ARIMA or Prophet) to forecast short-term traffic volume. The final analysis identifies key features or periods influencing traffic flow.",
            tools: ["Python", "Pandas", "NumPy", "scikit-learn", "Matplotlib/Seaborn", "Jupyter Notebook"],
        },
        {
        ...
        },
        {
            ...
            objective: "To explore and clean the **customer churn dataset**, conducting exploratory data analysis to identify behavior patterns and key features influencing churn. This project involves building and evaluating various classification models (e.g., Random Forest or Gradient Boosting) to achieve optimal model performance and accuracy. The final deliverable provides insights on customer lifetime value and important predictors.",
            tools: ["Python", "Pandas", "NumPy", "scikit-learn", "Matplotlib", "Seaborn", "Jupyter Notebook"],
        },
    ]
};
